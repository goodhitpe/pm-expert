...
**과제 1: 통합 관리가 필요한 사례 도출**

다음 상황에서 PM이 어떤 지식영역을 통합 관리해야 하는지 설명하세요:

**상황 1:** Week 8에 "모바일 앱 추가" 요청이 들어왔습니다.
- 영향받는 지식영역 3가지 작성
- 각 영역에서 PM이 고려해야 할 사항 작성

**상황 2:** 핵심 개발자 1명이 퇴사했습니다.
- 영향받는 지식영역 3가지 작성
- PM의 대응 방안 작성

**과제 2: 7개 프로세스와 산출물 매칭**

다음 표를 완성하세요:

| 프로세스 | 프로세스 그룹 | 주요 산출물 | PM의 핵심 역할 |
|---------|--------------|------------|---------------|
| 프로젝트 헌장 개발 | 착수 | 프로젝트 헌장 | (작성) |
| 관리 계획서 개발 | (작성) | (작성) | (작성) |
| 작업 지시 및 관리 | (작성) | (작성) | (작성) |
| 지식 관리 | (작성) | (작성) | (작성) |
| 작업 감시/통제 | (작성) | (작성) | (작성) |
...
## 6교시: 프로젝트 종료 및 Day 2 종합 실습 (1.5시간)
